...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    $name = $_POST['name'];
    $foto = $user['foto'];
    $target_dir = "../assets/uploads/profileAdmin/";
...
if (!is_dir($target_dir)) {
    ...
    if ($update) {
        $_SESSION['name'] = $name;
        header("Location: profile-admin.php?success=1");
        exit;
    } else {
...
<body>
  ...
  <div class="profile-card">
    <?php 
      $fotoPath = !empty($user['foto']) ? "../assets/uploads/profileAdmin/" . $user['foto'] : "../assets/uploads/default.jpg";
    ?>
